...
var itemEmots = [{t:'发呆', s:'01.gif'},{t:'微笑', s:'02.gif'},{t:'大笑', s:'03.gif'},{t:'得意', s:'04.gif'},{t:'加油', s:'05.gif'},{t:'愤怒', s:'06.gif'},{t:'难过', s:'07.gif'},{t:'撇嘴', s:'08.gif'},{t:'皱眉', s:'09.gif'},{t:'不屑', s:'10.gif'},{t:'呕吐', s:'11.gif'},{t:'微笑', s:'12.gif'},{t:'汗', s:'13.gif'},{t:'困', s:'14.gif'},{t:'惊讶', s:'15.gif'},{t:'抱抱', s:'16.gif'},{t:'爱', s:'17.gif'},{t:'耍酷', s:'18.gif'},{t:'骷髅', s:'19.gif'},{t:'囧', s:'20.gif'}];
var arrTools={GStart:{},GEnd:{},Separator:{},Cut:{t:'剪切 (Ctrl+X)'},Copy:{t:'复制 (Ctrl+C)'},Paste:{t:'粘贴 (Ctrl+V)'},Pastetext:{t:'粘贴文本'},Blocktag:{t:'段落标签'},Fontface:{t:'字体'},FontSize:{t:'字号'},Bold:{t:'加粗 (Ctrl+B)',s:'Ctrl+B'},Italic:{t:'斜体 (Ctrl+I)',s:'Ctrl+I'},Underline:{t:'下划线 (Ctrl+U)',s:'Ctrl+U'},Strikethrough:{t:'中划线 (Ctrl+S)',s:'Ctrl+S'},FontColor:{t:'字体颜色'},BackColor:{t:'背景颜色'},Removeformat:{t:'删除文字格式'},Align:{t:'对齐'},List:{t:'列表'},Outdent:{t:'减少缩进'},Indent:{t:'增加缩进'},Link:{t:'超链接'},Unlink:{t:'取消超链接'},Img:{t:'图片'},Flash:{t:'Flash动画'},Media:{t:'视频'},Emot:{t:'表情'},Table:{t:'表格'},Source:{t:'源代码'},Preview:{t:'预览'},Fullscreen:{t:'全屏编辑 (Esc)',s:'Esc'},About:{t:'关于 xhEditor'},More:{t:'more'}};
var toolsThemes={
    mini:'GStart,Bold,Italic,Underline,Strikethrough,GEnd,Separator,GStart,Align,List,GEnd,Separator,GStart,Link,Img,GEnd',
    simple:'GStart,Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,GEnd,Separator,GStart,Align,List,Outdent,Indent,GEnd,Separator,GStart,Link,Unlink,Img,Emot,GEnd',
    ...
    custom:'GStart,Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,Removeformat,GEnd,Separator,GStart,Align,List,Outdent,Indent,GEnd,Separator,GStart,Link,Unlink,Img,Flash,Table,GEnd,Separator,GStart,More,Source,GEnd',
    ubb:'GStart,Bold,Italic,Underline,Strikethrough,Separator,GStart,Link,Unlink,Removeformat,GEnd,Separator,GStart,Img,Emot,GEnd',
    simpleUbb:'GStart,Bold,Italic,Underline,Separator,GStart,Link,Unlink,GEnd,Separator,GStart,Emot,GEnd'
};
    ...
    this.exec=function(cmd)
    {
        ...
        switch(cmd)
        {
            ...
            case 'about':
                ...
                break;
            case 'more':
                _this.pasteHTML('<code class="more"></code>');
                break;
            default:
                _this._exec(cmd);
                break;
