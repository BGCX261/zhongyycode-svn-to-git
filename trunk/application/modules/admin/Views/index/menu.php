...
<div id="main">
  ...
  <? foreach ($this->menu as $item) { ?>
    <li class="<?=$item['class']?>"><a href="<?=$this->url($item['url'], '', true)?>" target="<?=isset($item['target']) ? $item['target'] : 'mainFrame'?>" title="<?=isset($item['title']) ? $item['title'] : $item['text']?>"><?=$item['text']?></a></li>
  <? } ?>
  </ul>
</div>
