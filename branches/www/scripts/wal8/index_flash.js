...
PicData[i]['title'] = '100M外链相册！现在就免费拥有！' ;
PicData[i]['stitle'] = '现在就注册，30秒后即可拥有100M超大空间外链相册！' ;
PicData[i]['link'] = 'register.php' ;
PicData[i]['blockid'] = '1' ;
i++
PicData[i] = new Array() ;
PicData[i]['img'] = '/images/02.jpg' ;
PicData[i]['title'] = '批量上传，批量外链！' ;
PicData[i]['stitle'] = '图片批量上传，批量外链！' ;
PicData[i]['link'] = 'userlogin.php' ;
PicData[i]['blockid'] = '2' ;
i++
PicData[i] = new Array() ;
PicData[i]['img'] = '/images/03.jpg' ;
PicData[i]['title'] = '无水印，支持GIF动画' ;
PicData[i]['stitle'] = '图片无水印，完美支持GIF动画，然你的图片动起来！' ;
PicData[i]['link'] = 'userlogin.php' ;
PicData[i]['blockid'] = '3' ;
i++
PicData[i] = new Array() ;
PicData[i]['img'] = '/images/04.jpg' ;
PicData[i]['title'] = '上传个人靓照，展示无限风采！' ;
PicData[i]['stitle'] = '将图片上传到【我的图册】，向朋友展示个人风采！' ;
PicData[i]['link'] = 'userlogin.php' ;
PicData[i]['blockid'] = '4' ;
