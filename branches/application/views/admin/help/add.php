    ...
    <form action="" method="post" id="submit">
        <table width="100%" align="left">
          ...
          <td>
            ...
            <tr>
              <th align="left">文档标题</th><td><input type="text" name="cname" size="80" value="" class="txt" /></td>
            <tr><th align="left">文档名</th>

                <td><input type="text" class="txt" name="title" size="80"  value="" /></td>
            </tr>
            <tr><th align="left">内容</th>
                <td> <?php echo Editor::create('XH', array('name' => 'content', 'value' => '', 'width' => '650'));?> </td>
            </tr>
        </table>
