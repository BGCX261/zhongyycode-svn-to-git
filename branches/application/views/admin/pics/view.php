...
<table width="100%" cellspacing="1" cellpadding="2" border="0" bgcolor="#98caef" style="margin-top: 10px;">
    <tbody><tr style="background: none repeat scroll 0% 0% rgb(236, 248, 255);"><th align="center" colspan="6">详细信息 [<a href="/admin/template/edit?id=<?=$row['id']?>">编辑</a>]</th></tr>
    <tr><td width="100"><b>ID</b></td>
    <td><?=$row['id']?></td><td width="100"><b>邮件模板名</b></td><td><?=$row['name']?> </td><td width="100"><b>邮件主题</b></td><td><?=$row['subject']?></td></tr>
    <tr>
