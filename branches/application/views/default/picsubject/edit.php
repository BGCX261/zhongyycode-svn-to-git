    ...
    <div class="mod_editor topics">
      ...
      <div class="main">
        ...
        <div class="bd">
          ...
          <input class="input_text" name="tags" type="text" value="<?=implode(" ", $tags);?>" />
          <br />
          <span class="text"> （多个标签以空格分开，如;人物 时间 地点） </span> </label>
          <div class="editor"> <?php echo Editor::create('XH', array('name' => 'content', 'value' => $info->content, 'width' => '650', 'height' => '700'));?> </div>
          <br />
