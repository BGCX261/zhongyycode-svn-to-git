...
<div id="side">
    <div class="side_up">
        <p class="user_head" style=""><a href="/user"><img src="<?=(!empty($auth['avatar'])) ? $auth['avatar']: '/images/album/no_avatar.png';?>" onerror="this.src='/images/album/no_avatar.png'" width="92" height="92"/></a></p>
        ...
        <p>已用空间：<?php echo ceil($auth['use_space'] / 1024 / 1024);?>M</a>&nbsp;<a href="/user" title="刷新缓存" style="color:red">刷新</a></p>
        <?php
            $all = $auth['group']['max_space'] + $auth['gift'];
            if ($all <= 0) $all = 1;
        ?>
        <p class="progressBar" style="float:left;"><span style="padding-left:0px;"><em style="left:<?php  echo ($auth['use_space'] / 1024 / 1024 / $all)* 51 ?>px"></em></span>
        <div class="user_txt" style="margin-left:70px;"><?php  echo round(($auth['use_space'] / 1024 / 1024 / $all )* 100) ?>%</div></p>
    </div>
     <div class="menu">
        <ul>
            ...
            <!--li><img src="/images/user/menu_04.gif" /> <a href="/category/manage">图片目录管理</a></li-->
