...
<link href="/styles/album/public.css" rel="stylesheet" type="text/css" />
<?php echo $script.$css; ?>
</head>
<body>
...
<div id="header">
    <div class="hd">
        <ul class="nav">
            ...
            <? if ($controller != 'index' && Auth::getInstance()->isAllow('index.access@admin')) { ?>
             <li><a href="/admin">后台管理</a>|</li>
            <?php } ?>
             <li><a href="/user/logout">退出</a>|</li>
            <?php } ?>

            <li><a style="cursor:pointer;" onclick="setHomepage();">设为首页</a>|</li>
            <li><a style="cursor:pointer;" onclick="addCookie();">加入收藏</a>|</li>
...
<div id="nav">
    <div class="nav_lists">
        <ul class="lists">
            <li><a class="default<?=(in_array($controller, array('index', 'help','about','picsubject') )) ? '_s' : '';?>" href="/">首页</a></li>
            <li><a class="nav_book<?=($directory=='book') ? '_s' : '';?>" href="/book">图书馆</a></li>
            <li><a class="nav_public<?=($controller=='pic') ? '_s' : '';?>" href="/pic">公共社区</a></li>
            <li><a class="user_center<?=(in_array($controller, array('user', 'category', 'pay', 'movehome', 'shopmove', 'message', 'userpic', 'job'))) ? '_s' : '';?>" href="/user">用户中心</a></li>
